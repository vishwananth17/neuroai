      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Join NeuroAI</h1>
          ...
          {successMessage && (
            <motion.div
              variants={itemVariants}
              className="mb-6 p-4 bg-green-500/15 border border-green-500/30 rounded-lg text-green-200 text-sm"
            >
              {successMessage}
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full mt-6 px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-indigo-500/50"
            >
              {loading ? (
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-slate-900 text-slate-400">Already registered?</span>
            </div>
          </div>
